...
- Hotfix 2026-08-31 (post-Sprint 23), 2 parts:
  ...
  - Live domain (operator): `https://lightsteelblue-seahorse-671905.hostingersite.com` — DB on Supabase. `docs/deploy-hostinger.md` has the minimum-env table + Supabase connection-string guidance + ISE/OOM troubleshooting.
